            ...
            <form action="{{ route('setupStep1') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <span data-bs-toggle="tooltip" title="The environment you want to deploy to. For coding you usually want to use 'local'"><i class="bi bi-question-circle"></i></span>
                    ...
                    <div class="col-md-6">
                        ...
                        <span data-bs-toggle="tooltip" title="APP_DEBUG offers error reporting for development purpose"><i class="bi bi-question-circle"></i></span>
                ...
                <div class="mb-2">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <span data-bs-toggle="tooltip" title="The application key is a unique base64 String. Click if you want a new one for your application"><i class="bi bi-question-circle"></i></span>
